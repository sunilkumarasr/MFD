...
class ServiceHomeAdapter: RecyclerView.Adapter<ServiceHomeAdapter.ServiceCategoryHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ServiceCategoryHolder {
        val view=LayoutInflater.from(parent.context).inflate(R.layout.layout_item_service_home,parent,false)
